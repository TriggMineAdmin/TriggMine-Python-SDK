# After a user logs out, the information about the user should be transmitted.
# Docs https://triggmine.freshdesk.com/support/solutions/articles/22000186389-6-user-log-out-event
